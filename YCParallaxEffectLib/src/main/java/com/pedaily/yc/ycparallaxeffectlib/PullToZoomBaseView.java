 ...
 * 时差特效，ListView控件
 */
public abstract class PullToZoomBaseView<T extends View> extends LinearLayout {
    ...
    public PullToZoomBaseView(Context context) {
        this(context, null);
    }

    public PullToZoomBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
